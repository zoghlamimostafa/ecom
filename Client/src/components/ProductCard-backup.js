...
const ProductCard = ({ data, gridView = true }) => {
    ...
    const handleAddToWishlist = async () => {
        ...
        try {
            console.log('📦 Dispatching toggleProductWishlist with:', productId);
            const result = await dispatch(toggleProductWishlist(productId)).unwrap();
    ...
    const handleViewProduct = (e) => {
        ...
        if (productIdentifier) {
            ...
            toast.error("Impossible d'afficher ce produit - Identifiant manquant");
        }
    };
                ...
                <div className="row align-items-center g-3">
                    <div className="col-md-3 col-sm-4">
                        <div className="modern-product-image-list">
                            ...
                            />
                            {tags?.includes('special') && <span className="special-badge">Spécial</span>}
                            {tags?.includes('featured') && <span className="featured-badge">Vedette</span>}
                        </div>
                    </div>
