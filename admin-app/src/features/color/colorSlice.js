  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getColors.fulfilled, (state, action) => {
        ...
        state.colors = action.payload ?? []; // Utilisation de l'opérateur de nullish (??) pour gérer les valeurs nulles ou non définies
      })
      ...
      .addCase(deleteAColor.fulfilled, (state, action) => {
        ...
        state.isError = false;
        state.isSuccess = true;
        state.deletedColor = action.payload?.title ?? "Unknown"; // Utilisation de l'opérateur de nullish (??) pour gérer les valeurs nulles ou non définies
      })
